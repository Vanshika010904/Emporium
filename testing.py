...
class Main:
    ...
    def login(self):
        ...
        self.pass_entry = Entry(self.login_frame, width=25, border=0, bg='white', font=('Lexend Deca', 16, 'normal'), show="*")
        self.pass_entry.place(x=493, y=346)

        self.btn = ctk.CTkButton(self.login_frame, text="Login", hover_color="#22282e", fg_color="black", bg_color="white", width=365, height=41, font=('Lexend Deca', 22, 'bold'), command=self.getVal)
    ...
    def register(self):
        ...
        self.dob_entry.bind("<Button-1>", self.pick_date)
        ...
        self.but = ctk.CTkButton(self.register_frame, text="Register", hover_color="#22282e", fg_color="black", bg_color="white", width=396, height=42, font=('Lexend Deca', 16, 'bold'))
